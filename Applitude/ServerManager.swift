...
class ServerManager: NSObject {
    ...
    func requestDishes() {
        ...
        for restaurant in restaurants {
            ...
            dishes.append(Dish(title: "Buffer med nystekt kylling, sei arrabiata og ovnsbakte amadinepoteter", price: "13,- pr. hg.", veggie: false, allergies: ["NA"], restaurant: restaurant))
